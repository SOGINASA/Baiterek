...
# In-memory challenge store is deprecated - now using database
# _challenges = {}
# _CHALLENGE_TTL = 300


def _cleanup_expired_challenges():
    """Удалить все истекшие challenges из базы данных"""
...
def _store_challenge(user_id, challenge, challenge_type):
    """Сохранить challenge в базу данных"""
    # Удалить старые challenges для этого пользователя и типа
...
def _get_challenge(user_id, challenge_type):
    """Получить и удалить challenge из базы данных (одноразовый)"""
    ...
    # Удалить challenge после использования (одноразовый)
...
def authenticate_options():
    """Generate authentication options for a user (by email or nickname)."""
    data = request.get_json()
