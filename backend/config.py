...
class Config:
    ...
    # Настройки CORS
    CORS_ORIGINS = ["http://localhost:3000", "http://localhost:3001", "http://127.0.0.1:3000", "https://food-track-beta.vercel.app", "https://foodtrack.beast-inside.kz"]
    ...
    # Admin Panel
    ADMIN_USERNAME = os.environ.get('ADMIN_USERNAME', 'ft_admin')
    ADMIN_PASSWORD = os.environ.get('ADMIN_PASSWORD', 'FoodTrack@2024#Panel')
